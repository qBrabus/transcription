...
API_BASE_URL = os.environ.get("TRANSCRIPTION_API_BASE", "http://10.200.50.46:8000/v1").rstrip("/")
API_KEY = os.environ.get("TRANSCRIPTION_API_KEY", "").strip()
API_CHAT_MODEL = os.environ.get("TRANSCRIPTION_CHAT_MODEL", "").strip()
API_TRANSCRIPTION_MODEL = os.environ.get("TRANSCRIPTION_TRANSCRIPTION_MODEL", "").strip()
API_TIMEOUT = float(os.environ.get("TRANSCRIPTION_API_TIMEOUT", "60"))
API_TRANSCRIPTION_TIMEOUT = float(os.environ.get("TRANSCRIPTION_API_TRANSCRIPTION_TIMEOUT", "300"))
